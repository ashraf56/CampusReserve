...
const DetailCollege = () => {
...

 {
  ColInfo.map(cg=> (
    ...
    <div>
<div className="hero min-h-screen" style={{backgroundImage: `url(${cg.collegeImage})`}}>
...
<div className="card w-full bg-base-200 ">
  <div className="card-body">
    ...
    <span className='uppercase font-extrabold'>researchName </span> 
    <p className='text-5xl'> {cg.researchWorks[0].researchName}</p>
    <span className='uppercase font-extrabold'>researchLink</span>
    <p className='link link-hover'>  {cg.researchWorks[0].researchLink}</p><span className='uppercase font-extrabold '>researchDetails</span>
    <p className='text-2xl'> {cg.researchWorks[0].researchDetails}</p>
...
<div className="hero ">
  <div className="hero-content flex-col lg:flex-row">
   <div >
   <img src="https://img.freepik.com/free-vector/sport-equipment-concept_1284-13034.jpg?w=740&t=st=1690115452~exp=1690116052~hmac=a1322629dd2ac82af76d5d599f0997a0f818cc4ecf59ee2db951082e71677251" className="max-w-sm rounded-lg " />
   </div>
